...
public class SimpleBroadcastsActivity extends Activity {
    ...
    public void onClickBroadcastButton(View v) {
        // Blue button clicked.
        Toast.makeText(SimpleBroadcastsActivity.this, "Broadcasting intent: IE5",
    ...
    public static class MyDancingBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Toast.makeText(context, "Get Down and Boogie, cause dem aliens here ;)", Toast.LENGTH_LONG)
                    .show();
        }
    }
